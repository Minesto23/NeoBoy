/**
 * NeoBoy - Emulator Header Component
 * 
 * Top header with branding and navigation
 */

import React from 'react';
import './EmulatorHeader.css';

export function EmulatorHeader({ coreType = 'GB' }) {
    const getCoreFullName = (type) => {
            ...
            <div className="header-content">
                <div className="logo-section">
                    <div className="logo">
                        ...
                        <span className="logo-boy">Boy</span>
                    </div>
                    <div className="core-badge">
                        {getCoreFullName(coreType)}
                    </div>
                </div>
